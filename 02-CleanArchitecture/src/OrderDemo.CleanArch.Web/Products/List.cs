...
public class List(IMediator mediator) : Endpoint<ListProductsRequest, ProductListResponse, ListProductsMapper>
{
...
public record ProductListResponse : UseCases.PagedResult<ProductRecord>
{
...
public sealed class ListProductsMapper
  : Mapper<ListProductsRequest, ProductListResponse, UseCases.PagedResult<ProductDto>>
{
  public override ProductListResponse FromEntity(UseCases.PagedResult<ProductDto> e)
  {
    var items = e.Items
