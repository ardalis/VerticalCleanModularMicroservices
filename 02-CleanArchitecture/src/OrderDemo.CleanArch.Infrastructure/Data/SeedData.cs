...
public static class SeedData
{
  ...
  public static readonly Product Product1 = new(ProductId.From(1), "Widget", 9.99m);
  public static readonly Product Product2 = new(ProductId.From(2), "Gadget", 19.99m);

  public static async Task InitializeAsync(AppDbContext dbContext)
  {
    if (await dbContext.Contributors.AnyAsync() || await dbContext.Products.AnyAsync())
    {
      Console.WriteLine("DB has data - seeding not required.");
