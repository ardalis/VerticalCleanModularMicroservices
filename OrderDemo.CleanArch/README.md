...
```powershell
dotnet ef database update -c AppDbContext -p ../OrderDemo.CleanArch.Infrastructure/OrderDemo.CleanArch.Infrastructure.csproj -s OrderDemo.CleanArch.Web.csproj
```
